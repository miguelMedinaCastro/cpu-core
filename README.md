...
Este tutorial foi feito em formato de módulos. Você é livre para seguir a ordem linear ou pular direto para a parte que mais te interessa no projeto:

* 1\. [fundamentos.md](fundamentos.md "mention"): o básico que você precisa saber sobre VHDL e Portas Lógicas. _**(Recomendado se você nunca viu circuitos digitais antes!)**_
* 2\. [preparando-o-ambiente.md](preparando-o-ambiente.md "mention"):  como instalar o simulador (GHDL), clonar o nosso repositório no seu terminal e rodar a CPU no seu computador.
* 3\. [modulos.md](modulos.md "mention"): Entenda os componentes da CPU por completo!
